...
def display_page(selected_option):
    ...
    if selected_option == "Home":
        ...
        st.write('''Welcome to our Hotel Recommendation System! 🌟 Whether you're looking for a budget-friendly stay 💸, a luxurious escape ⭐, or a hotel with specific amenities like free Wi-Fi or a pool 🏊, we've got you covered. Explore beautiful tourist destinations 🌍, find the perfect accommodations with ease, and make your travel planning a breeze. Start your journey with us today and discover the best places to stay for your next adventure! ✈️🏖️🏨''')
...
# ------------------------------------------------------------------------------------------------------------------------------------------
with st.sidebar:
    selected = option_menu("HOTELREC", ["Home", 'Search','Stays','Attractions','Settings',"Account",'Help'], 
